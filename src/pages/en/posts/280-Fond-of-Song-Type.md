...
The idea is pretty good. The underlying storage is still a Git repository, but the working copy model is simpler and fits coding agents better, so when the AI makes a mess it is easier to clean up.
<img src="https://cdn.tw93.fun/uPic/OAQjsa02.png" width="800" />

**How to get more out of Mole's screen and keyboard cleaning mode**
<https://mole.fit/>
A lot of people ask what to do when they also want to wipe the keyboard while cleaning the screen. That is actually supported by default. You need to enable the input protection permission for screen cleaning in Settings, then enter the cleaning mode from the logo. I highly recommend setting a shortcut for it. After that you can comfortably wipe your screen and keyboard with a soft cloth, and the keyboard will not register stray presses.
